  ...
  /*--------------------------------------:noTabs=true:tabSize=2:indentSize=2:--
    ...
    --  $LastChangedDate: 2006-12-23 11:31:46 +1300 (Sat, 23 Dec 2006) $
...
HTMLArea.version =
{
  ...
  'Date'      : '$LastChangedDate: 2006-12-23 11:31:46 +1300 (Sat, 23 Dec 2006) $'.replace(/^[^:]*: ([0-9-]*) ([0-9:]*) ([+0-9]*) \((.*)\) \$/, '$4 $2 $3'),
  'Revision'  : '$LastChangedRevision: 621 $'.replace(/^[^:]*: (.*) \$$/, '$1'),
...
{
  html = html.replace(/%28/g,'(').replace(/%29/g,')');
  if ( !this.config.fullPage )
  {
    this._doc.body.innerHTML = html;
    this._doc.body.innerHTML = this._doc.body.innerHTML.replace(/%28/g,'(').replace(/%29/g,')');
  }
  else
  {
  ...
  this._textArea.value = this._textArea.value.replace(/%28/g,'(').replace(/%29/g,')');
};
