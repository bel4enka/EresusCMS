...
--
-- ВНИМАНИЕ!!!
-- Этот дамп не протестирован и не рекомендуется к использованию
--
-- $Id$
-- --------------------------------------------------------
...
INSERT INTO pages VALUES(1, 'main', 0, '�������', '�������', '', '������� ��������', '', 0, TRUE, 5, TRUE, '', 'default', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO users VALUES(1, 'root', '74be16979710d4c4e7c6647856088456', 1, '0000-00-00 00:00:00', 0, 0, 1, '������ ���������', 'support@example.org', NULL);
