Инструкция по установке Eresus 2.10b2 (17.09.07)
...
3. ИСТОРИЯ ИЗМЕНЕНИЙ
  ...
  [#] Исправлены плагины vars и faq
  [+] Добавлена библиотека templates
  [*] Незначительные улучшения в АИ
  [*] В КИ для загрузки шаблона теперь используется библиотека templates
  [+] В kernel.php добавлена константа FILE_APPEND и функции fileread, filewrite и filedelete
  [*] Управление основными шаблонами страниц переделано с использованием библиотеки templates
