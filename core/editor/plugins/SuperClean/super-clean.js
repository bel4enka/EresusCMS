...
HTMLArea.Config.prototype.SuperClean =
{
  ...
  'filters': { 'tidy': HTMLArea._lc('General tidy up and correction of some problems.', 'SuperClean'),
               ...
               'word': HTMLArea._lc('Extended Word-Filter', 'SuperClean'),
               'remove_fonts': HTMLArea._lc('Remove font tags', 'SuperClean'),
               'remove_lang': HTMLArea._lc('Remove lang attributes.', 'SuperClean'),
               'remove_classes': HTMLArea._lc('Remove class attributes', 'SuperClean'),
               'remove_styles': {label:HTMLArea._lc('Remove inline styles', 'SuperClean'), checked:false},
               'paragraph': {label:HTMLArea._lc('Remove paragraphs', 'SuperClean'), checked:false},
