...
require_once TESTS_SRC_DIR . '/core/UI/List/Control/Edit.php';

/**
 * @package Eresus
 * @subpackage Tests
 */
class Eresus_UI_List_Control_Edit_Test extends PHPUnit_Framework_TestCase
{
	/**
	 * @covers Eresus_UI_List_Control_Edit::render
	 */
	public function test_render()
	{
		$ctrl = new Eresus_UI_List_Control_Edit(new Eresus_UI_List());
