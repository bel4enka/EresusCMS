...
{
    /**
     * @covers Eresus\CmsBundle\Sections::branch_ids
     */
    public function testBranchIds()
    {
        $branch_ids = new ReflectionMethod('Eresus\CmsBundle\Sections', 'branch_ids');
        $branch_ids->setAccessible(true);

        $p_index = new ReflectionProperty('Eresus\CmsBundle\Sections', 'index');
