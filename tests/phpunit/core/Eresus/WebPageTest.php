...
require_once TESTS_SRC_DIR . '/core/Eresus/WebPage.php';
...
{
	/**
	 * Проверяем Eresus_WebPage::linkScripts
	 *
	 * @covers Eresus_WebPage::linkScripts
	 * @covers Eresus_WebPage::renderHeadSection
	 * @covers Eresus_WebPage::renderBodySection
	 */
	public function test_linkScripts()
	{
		...
		$page = new Eresus_WebPage();
		$page->linkScripts('head.js');
		$page->linkScripts('body.js', 'defer');

		$renderHeadSection = new ReflectionMethod('Eresus_WebPage', 'renderHeadSection');
		...
		$renderBodySection = new ReflectionMethod('Eresus_WebPage', 'renderBodySection');
	...
	/**
	 * Проверяем Eresus_WebPage::addScripts
	 *
	 * @covers Eresus_WebPage::addScripts
	 * @covers Eresus_WebPage::renderHeadSection
	 * @covers Eresus_WebPage::renderBodySection
	 */
  ...
  /**
	 * @covers Eresus_WebPage::setMetaHeader
	 */
	public function test_setMetaHeader()
	{
     $p_head = new ReflectionProperty('Eresus_WebPage', 'head');
  ...
  /**
	 * @covers Eresus_WebPage::setMetaTag
	 */
  ...
  /**
	 * @covers Eresus_WebPage::linkStyles
	 */
  ...
  /**
	 * @covers Eresus_WebPage::addStyles
	 */
