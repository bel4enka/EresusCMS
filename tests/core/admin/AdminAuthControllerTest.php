 ...
 * ${product.description}
 *
 * Модульные тесты контроллёра аутентификации АИ
 *
...
require_once 'core/admin/AdminAuthController.php';
...
class AdminAuthControllerTest extends PHPUnit_Framework_TestCase {
	...
	{
		$stub = new AdminAuthController();
		$this->assertTrue($stub instanceof FrontController);
	}
	//-----------------------------------------------------------------------------
