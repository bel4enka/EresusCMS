...
//-------------------------------------------------------------------------------
// Одна установка Eresus CMS может обслуживать как один сайт, так и несколько.
// Установите этот параметр в true, если хотите создать несколько сайтов
//-------------------------------------------------------------------------------
Eresus_Config::set('eresus.cms.multiple', false);
