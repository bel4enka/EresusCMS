...
class SectionsTest extends PHPUnit_Framework_TestCase {
	...
	//-----------------------------------------------------------------------------
 /**
	* Получение существующего раздела
	*
	*/
	function testMethod_Parents_get_id()
	{
		$this->assertEquals(array(0, 3), $this->fixture->parents(12));
	}
	//-----------------------------------------------------------------------------
 /**
	* Попытка для несуществующего раздела
	*
	*/
