...
class SetPermsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->chmodRecursive($kernel->getRootDir() . '/data');
        $this->chmodRecursive($kernel->getRootDir() . '/style');
        $this->chmodRecursive($kernel->getRootDir() . '/templates');
        $this->chmodRecursive($kernel->getRootDir() . '/var/cache');
        $this->chmodRecursive($kernel->getRootDir() . '/var/logs');
        $output->writeln('Done.');
    }
