...
class TFiles
{
	...
	function renderControls()
	{
		...
		$result =
			...
			"<tr><td align=\"center\">��������� ����</td><td><form name=\"upload\" action=\"".$Eresus->request['url']."\" method=\"post\" enctype=\"multipart/form-data\"><div id=\"fm_upload\"><input type=\"file\" name=\"upload\" size=\"50\"><input type=\"submit\" value=\"���������\"> ������������ ������ �����: ".ini_get('upload_max_filesize')."</div></form></td></tr>".
