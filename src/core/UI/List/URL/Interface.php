 ...
 * Интерфейс построителя шаблонов адресов
 *
 * Построитель адресов используется {@link Eresus_UI_List списком} чтобы создавать шаблоны адресов
 * для различных элементов управления, таких как переключатель страниц, «Изменить», «Удалить» и
 * т. д.
 *
