...
use Eresus\ORM\Registry;
use Eresus\Security\SecurityManager;
use Eresus\Templating\TemplateManager;
use Eresus\UI\Control\Control;
use Eresus\UI\Control\DeleteControl;
use Eresus\UI\Control\EditControl;
use Eresus\UI\Control\ToggleControl;
use Eresus\UI\Control\UrlBuilder\QueryUrlBuilder;
use Eresus\UI\Table\Column;
use Eresus\UI\Table\ControlsColumn;
use Eresus\UI\Table\DataProvider\EntityProvider;
use Eresus\UI\Table\ListTable;
...
class AccountsController extends Controller
{
    ...
    private function indexAction(Request $request)
    {
        ...
        return $this->renderView('AccountManager/Index.html', array(
            'addButton' => $addButton,
            'list' => $list
        ));
    }
